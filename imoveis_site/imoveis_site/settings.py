"""
Django settings for imoveis_site project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-q@0vy#iwhy^0x%sy)*e^qq@4t(qthmuo#jadq+z70@9%+oebjn')
...
WSGI_APPLICATION = 'imoveis_site.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

# Usa PostgreSQL em produção (Render) ou SQLite em desenvolvimento
